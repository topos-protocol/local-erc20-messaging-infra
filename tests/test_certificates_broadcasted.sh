...
# Get last certificate generated by topos and incal sequencers
...
do
    ...
    if [ $counter -eq $NUMBER_OF_DELIVERIES ]; then
        ...
        echo "Certificates $topos_certificate and $incal_certificate ARE NOT delivered to all TCE nodes"
        if [[ "$i" != '10' ]]; then
